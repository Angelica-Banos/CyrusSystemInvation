...
public class ControladorMapa : MonoBehaviour {
    ...
    public GameManager gameManager; public int busc;
    ...
    private void Start() {
        ...
        vertices[gameManager.EscenaActual.identificador].GetComponent<Image>().color = Color.red; buscado(busc); 
    } 
